...
export type ThemeId = 'hermes-orange' | 'ai' | 'blade-runner' | 'fsociety' | 'anime'
...
export const THEMES: { id: ThemeId; label: string; icon: string }[] = [
  { id: 'hermes-orange', label: '爱马仕橙', icon: '●' },
  { id: 'ai', label: '神经觉醒', icon: '◆' },
  { id: 'blade-runner', label: '银翼城市', icon: '◈' },
  { id: 'fsociety', label: '黑客终端', icon: '▣' },
  { id: 'anime', label: '动漫能量', icon: '◎' },
]
