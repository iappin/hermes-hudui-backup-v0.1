      ...
      {data.map((h: any) => {
        ...
        return (
          <div
            ...
            title={`${String(h.hour).padStart(2, '0')}:00 — ${h.sessions} 次会话，${h.messages} 条消息`}
          />
        )
      })}
    </div>
...
export default function PatternsPanel() {
  ...
  return (
    <>
      ...
      <Panel title="小时活动" className="col-span-1">
      ...
      <Panel title="重复提示词" className="col-span-1">
